...
async function main() {
  ...
  if (testerBalance.lt(ethers.utils.parseEther("1"))) {
    console.log(
      "Tester account balance before transfer:",
    ...
    console.log(
      "Tester account balance after transfer:",
      (await tester.getBalance()).toString()
    );
  } else {
  ...
  if (testerTokenBalanceBefore.lt(100)) {
    console.log(
      "Deployer account token balance before transfer:",
      deployerTokenBalanceBefore.toString()
    );
    console.log(
      "Tester account token balance before transfer:",
      testerTokenBalanceBefore.toString()
    );
    ...
    console.log(
      "Deployer account token balance after transfer:",
      deployerTokenBalanceAfter.toString()
    );
    console.log(
      "Tester account token balance after transfer:",
      testerTokenBalanceAfter.toString()
    );
    ...
    console.log(
      "Tester account have enough tokens. Balance:",
      testerTokenBalanceBefore.toString()
    );
  }
  ...
  if (testerTokenBalanceBefore.gte(10)) {
    ...
    console.log(
      "Tester don't have enough tokens to send. Balance:",
      testerTokenBalanceBefore.toString()
    );
  }
}
